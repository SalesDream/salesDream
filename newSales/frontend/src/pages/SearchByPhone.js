...
export default function SearchByPhone() {
  ...
  // Filters (TEXT inputs are strings; only state_code is array)
  ...
  const extraColumns = useMemo(() => {
    return ALL_FIELDS.filter((fld) => !excludeFromExtras.has(fld)).reduce(
      (acc, field) => {
        const def = {
      ...
      <div className="relative z-20 shrink-0 w-[250px] px-3">
        ...
        <div className="top-4 z-30 pb-3">
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-3">
            <label className="sr-only">Search by Phone</label>
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Enter phone (digits or formatted)"
