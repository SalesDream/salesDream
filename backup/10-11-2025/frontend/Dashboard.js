        ...
        <div className="flex items-center gap-2 text-[12px] text-slate-700">
          ...
          {phoneVal ? (
            <>
              ...
              {/* <button title="Copy Phone" onClick={() => copyToClipboard(email)} className="ml-2 p-1 rounded hover:bg-slate-100">
        ...
        <div className="flex items-center gap-2 text-[12px] text-slate-700">
          ...
          {emailVal ? (
            <>
              ...
              {/* <button title="Copy email" onClick={() => copyToClipboard(email)} className="ml-2 p-1 rounded hover:bg-slate-100">
              <Copy className="w-3.5 h-3.5 text-slate-500" />
            </button> */}
            </>
          ) : (
