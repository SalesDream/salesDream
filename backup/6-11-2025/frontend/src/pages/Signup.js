...
export default function Signup() {
  // phase: 1 => initial (request OTP), 2 => verify OTP, 3 => success message
      ...
      <div className="w-full max-w-4xl rounded-2xl shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2 bg-white">
        ...
        >
          ...
          <div
            ...
            style={{ bottom: 10 }}
          >
            <h2 className="text-white text-lg font-semibold mb-2 drop-shadow-lg">
