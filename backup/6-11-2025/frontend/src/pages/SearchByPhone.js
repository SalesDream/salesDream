// src/pages/SearchByPhone.jsx (updated to match SearchByEmail columns)
import React, {
  useEffect,
  useMemo,
  useRef,
...
export default function SearchByPhone() {
  ...
  // Compact renderers (reused) - PEOPLE renderer remains but contact label now shows actual values + copy buttons
